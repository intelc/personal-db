...
class Tracker:
    ...
    def __post_init__(self):
        self.log = logging.getLogger(f"personal_db.core.tracker.{self.name}")
    ...
    def resolve_person(self, alias: str, *, auto_create: bool = True) -> int | None:
        from personal_db.core.entities import resolve_person
    ...
    def resolve_topic(self, alias: str, *, auto_create: bool = True) -> int | None:
        from personal_db.core.entities import resolve_topic
